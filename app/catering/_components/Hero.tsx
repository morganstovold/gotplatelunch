    ...
    <section className="relative w-full py-24 md:py-36 lg:py-52 flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 flex flex-col gap-6 items-center text-center px-4 sm:px-6">
        <motion.h1
          ...
          className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-white relative inline-block"
        >
          Catering
          <motion.span
        ...
        >
          Let us cater your next event with authentic Hawaiian flavors!
        </motion.p>
      </div>
    </section>
  );
